...
A camada Facet pertmite criar permite dividir o gráfico criado a partir de uma terceira variável
...
ggplot(data=jn1, mapping=aes(x=sigla, y=media))+
  geom_col()+
  ggtitle("Teste")+
  theme(axis.title = element_text(color = "red", hjust = 0.5, face = "bold", family= "Times"),
